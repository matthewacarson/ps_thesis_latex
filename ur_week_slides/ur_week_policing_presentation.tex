...
\begin{frame}{Logistic Regression: Income Only}
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
			...
			$e^{-0.1326502} = 0.8758$ \pause
			
			\vspace{20pt}	
			
			$1 - 0.8758 = 0.1242$ \pause
			
			\vspace{20pt}	
			
			For every \$10k in income \pause $\rightarrow$ 12.42 \% decrease in the odds of a census tract experiencing at least one LUOF.
        \end{column}
    \end{columns}
\end{frame}
