...
$\textbf{H}_1$: &\acrshort{luof} rates should be the greatest in the lower income quintiles than in the upper income quintiles.
\end{tabular}
...
\noindent
\begin{tabular}{@{} l @{\hspace{18pt}} p{432pt} @{}}
$\textbf{H}_3$: &The probability that a census tract has experienced at least one \acrshort{luof} should increase as income increases.
\end{tabular}
