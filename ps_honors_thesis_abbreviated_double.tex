...
\begin{figure}[H]
  \centering % width=\mywidth, height=0.4\textheight
  \includegraphics[width=\mywidth]{images/majority_race_only_ind}
...
\begin{figure}[H]
  \centering % width=\mywidth, height=0.4\textheight
  \includegraphics[width=\mywidth]{images/income_quintiles_only_ind}
...
\begin{figure}[H]
  \centering % width=\mywidth, height=0.4\textheight
  \includegraphics[width=\mywidth]{images/combined}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
\begin{figure}[H]
  \centering % width=\mywidth, height=0.4\textheight
  \includegraphics[width=\mywidth]{images/race_only_denom_race}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
%     \centering
%     \includegraphics[width=\textwidth]{images/LUOF_logit_income_only}
%     \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
%   \begin{subfigure}[b]{0.45\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{images/race_proportions_logit}
%     \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
%     \caption[Predicted Probability of a LUOF (Race Only)]{Predicted Probability of a LUOF (Race Only).}
%     \label{fig:logit_race_propor}
%   \end{subfigure}
%   \caption{Comparison of LUOF Predicted Probabilities: Income vs. Race}
...
\begin{figure}[H]
  \centering % width=\mywidth, height=\textheight
  \includegraphics[width=\mywidth, height=67mm]{images/LUOF_logit_income_only}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
  \caption[Predicted Probability of a LUOF (Income Only)]{Predicted Probability of a LUOF (Income Only).}
  \label{fig:logit_income_plot}
\end{figure}
...
\end{equation}
\noindent{}where \texttt{i} is a census tract; \texttt{Proportion} is the proportion of the racial or ethnic group living in the \texttt{i}$^\text{th}$ census tract. Three separate regressions were run, one for the proportion black, one for the proportion Hispanic/Latino, and one for the proportion non-white (\autoref{tab:proportions_only} [Appendix]).

\begin{figure}[H]
  \centering % width=\mywidth, height=\textheight
  \includegraphics[width=\mywidth]{images/race_proportions_logit}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\mywidth]{images/ame_race_by_income}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\mywidth]{images/race_proportion_of_total_bar}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
  \caption{LUOFs by Race/Ethnicity}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\mywidth]{images/total_pop_quintiles_race}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
\noindent{}Notwithstanding this anomaly, there is still a striking disparity between the proportion of whites living in the lowest-income tracts and the proportion of whites killed in those tracts.
...
% Racial Proportions Logistic table
